function descriptionGenerator(item){
    var title = item.description + " | " + item.upc;
    ...
    if(item.info.action != ''){ html = html + "Action: "+item.info.action+"<br />" };
    if(item.info.capacity != ''){ html = html + "Capacity: "+item.info.capacity+"<br />" };
    if(item.info.caliber != ''){ html = html + "Caliber: "+item.info.caliber+"<br />" };
    if(item.info.barrelLength != ''){ html = html + "Barrel Length: "+item.info.barrelLength+"<br />" };
    if(item.info.finish != ''){ html = html + "Finish: "+item.info.finish+"<br />" };
    if(item.info.sights != ''){ html = html + "Sights: "+item.info.sights+"<br />" };
    if(item.info.stock != ''){ html = html + "Stock: "+item.info.stock+"<br />" };
    if(item.longDescription != ''){ html = html + "Description: "+item.longDescription+"<br />" };
    html = html + "</div>";
